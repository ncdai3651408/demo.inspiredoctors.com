...
if (defined('DB_UNIT_TESTS') && DB_UNIT_TESTS && file_exists(dirname(__FILE__).'/tests/tests.php')) {
	include_once(dirname(__FILE__).'/tests/tests.php');
}
